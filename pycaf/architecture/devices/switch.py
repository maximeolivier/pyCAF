...
class Switch():
    """@brief Swicth definition and features
    ...
    def __init__(self, name = None, manufacturer = None, osversion = None, hostname = None):
        ...
        self.vlan = nf.VlanList()
        self.switchport = nf.SwitchportList()
    ...
    def __str__(self):
        """
        Print the caracteristics of the switch
        """
        # General caracteristics
        print "\nSwicth name : " + str(self.name)
